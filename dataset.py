...
import librosa
import numpy as np
from util import bs_handler, MOUTH_BS, train_val_test_index
import pickle
...
def read_data(args):
    ...
    for k, v in data.items():
        ...
        if key in [165,168,172,174,185,193,195,200,329,330,529,621,
                   ...
                   930,937,939,183,850,932,180,186,638,922] and (dataset_name=="yifeng" or dataset_name=="clean_yifeng"):
            continue
        
        if key in train_ind or dataset_name=="yifeng_150" or key in test_ind or key in [42]:
...
def create_dataloaders(args):
    ...
    max_x = int(args.sampling_rate * args.max_audio_length)
    max_y = int(args.output_fps * args.max_audio_length)
